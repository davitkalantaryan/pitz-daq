...
function varargout = dev_test_for_daq_browser( varargin )
%
%
% file:         dev_test_for_daq_browser.m
...
switch optionR
    case 'info'
        ...
        %data =dev_mex_daq_browser('--get-file-entries','/acs/pitz/daq/2018/06/pitzrf2.adc/PITZ_DATA.pitzrf2.adc.2018-06-10-1255.root');
        data =dev_mex_daq_browser('--get-file-entries','/acs/pitz/daq/2018/06/pitznoadc0/PITZ_DATA.pitznoadc0.2018-06-10-0540.root');
    ...
    case 'entries'
        ...
        %data =dev_mex_daq_browser('--get-data-for-entries','/acs/pitz/daq/2018/06/pitznoadc0/PITZ_DATA.pitznoadc0.2018-06-10-0540.root',branches);
        data =dev_mex_daq_browser('--get-data-for-entries','/acs/pitz/daq/2018/06/pitzrf2.adc/PITZ_DATA.pitzrf2.adc.2018-06-10-1255.root',branches);
    otherwise 
        time_1 = '2018-06-10_09:25:48';
        time_2 = '2018-06-10_09:25:50';
...
%return;
        ...
        %dev_mex_daq_browser('--set-log-level',10);
        %data =dev_mex_daq_browser('--get-data-for-time-interval',branches,time1i32,time2i32,'--debug-app');
        data =dev_mex_daq_browser('--get-data-for-time-interval',branches,time1i32,time2i32);
end
